...
const OrderByPopulation = () => {
  ...
  return (
    <aside className="hidden sm:block p-1 cursor-pointer">
      <select onChange={handleOrderByPopulation} className="outline-none w-3/4 p-1 font-semibold border-transparent rounded bg-gradient-to-b from-[#f5b7b1] to-[#cb4335] cursor-pointer text-[#201d1d] hover:text-white hover:bg-gradient-to-b hover:from-[#cb4335] hover:to-[#f5b7b1] duration-1000 active:scale-75 transition-transform sm:w-full">
